...
exports.L2_CROSS_DOMAIN_MESSENGER = exports.ETH_ADDRESS = exports.DISCORD_WEBHOOK_URL = exports.ETHERSCAN_PROVIDER = exports.MAINNET_WALLET = exports.MAINNET_PROVIDER = exports.MAINNET_RPC_URL = exports.CHAINS = exports.ALCHEMY_KEY = exports.PRIVATE_KEY = void 0;
...
exports.CHAINS = [
    ...
    {
        name: 'linea',
        provider: new ethers_1.providers.JsonRpcProvider(`https://linea-mainnet.g.alchemy.com/v2/${exports.ALCHEMY_KEY}`),
        wallet: new ethers_1.Wallet(exports.PRIVATE_KEY, new ethers_1.providers.JsonRpcProvider(`https://linea-mainnet.g.alchemy.com/v2/${exports.ALCHEMY_KEY}`)),
